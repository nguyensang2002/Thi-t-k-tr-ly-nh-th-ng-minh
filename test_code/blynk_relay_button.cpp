...
#define BLYNK_TEMPLATE_ID "TMPL6zM9K9Y01"
#define BLYNK_TEMPLATE_NAME "ESP32 Automation1"
#define BLYNK_AUTH_TOKEN "54LUfTbYl5EwG74z-INhDWqHmA5QZK_R"
...
void setup()
{
  ...
  digitalWrite(relay2_pin, OUTPUT);
  digitalWrite(relay3_pin, OUTPUT);
  digitalWrite(relay4_pin, OUTPUT);
  //--------------------------------------------------------------------
